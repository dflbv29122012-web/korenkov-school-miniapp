        ...
        <ul className="card-list">
          ...
          {filtered.map(hw => (
            <li key={hw.id} className="card">
              ...
              {hw.attachment_url && (
                hw.attachment_type === 'image'
                  ? <img src={hw.attachment_url} alt="ДЗ" className="hw-attachment-img" />
                  : <a className="link" href={hw.attachment_url} target="_blank" rel="noreferrer">📎 Открыть файл ДЗ</a>
              )}
              {hw.review_video_url && (
